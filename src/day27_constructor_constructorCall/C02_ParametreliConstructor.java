...
public class C02_ParametreliConstructor {
	...
	public static void main(String[] args) {
		...
		// istersek parametreli constructor lar olusturup daha obje olustururken
		// istedigim ozellikleri atayabilirim
		
		
		
		// ayni isimle(Car1) obje olusturabilirim cunku digeri baska classta
