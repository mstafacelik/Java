...
public class C04_Remove {
	...
	public static void main(String[] args) {
		...
		System.out.println(harfler.remove(1)); // Z Bu satir gidip 1 index indeki
		// elemani remove eder ve delil olarak remove ettigi elemani
		// bize getirir :)
		// yani bur method Z yi kaldir kalani yazdir demek DEGILDIR!
		...
		System.out.println(harfler.remove("A")); // true----> ilk buldugu A yi sildi
		...
		// java remove(index) ve remove(Object) methodlari karismasin diye girilen sayiyi
