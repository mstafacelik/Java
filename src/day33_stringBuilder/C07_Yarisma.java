...
public class C07_Yarisma {
	...
	public static void main(String[] args) {
		...
		// For loop ile 1000 defa bir islem yapalim. Oncesinde ve sonrasinda zamani kontrol
		// edip StringBuilder ve String class’larinin performanslarini karsilastiralim. 
		...
		sb.trimToSize();   // capacity i length boyutuna indirir. bunu yapmasaydik kapasite 7+16=23 olurdu.
		...
		for (int i = 0; i < 1000; i++) {
			sb.append(" ");
			// sb oldugu icin ekleme yapmak icin append() kullanilir. sb+= kullanamayiz burda
		}
