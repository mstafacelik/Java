...
public class C06_SubSequence {
	...
	public static void main(String[] args) {
		...
		// ancak substring() methodu string class indan geldigi icin substring() kullandigimda
		// arkasindan String method larini kullanabilirim ama immutable olur
